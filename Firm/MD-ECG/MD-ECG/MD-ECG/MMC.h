...
#define CS_LOW()	PORTC_OUTCLR = SS_uSD;				//habilita slave		/* CS=low */
#define	CS_HIGH()	PORTC_OUTSET = SS_uSD;				//Desabilita slave			/* CS=high */
#define	FCLK_SLOW()	SPIC_CTRL |= SPI_PRESCALER_DIV128_gc;	/* Set slow clock (F_CPU / 128) */
#define	FCLK_FAST()	SPIC_CTRL |= SPI_CLK2X_bm;				//drobra a freq da SPI 	/* Set fast clock (F_CPU / 64) */
